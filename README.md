...
Claude Code interaction system that operates through email.

**Live site:** [airut.org](https://airut.org)

## Example Project

This repository serves as a simple demonstration of the Airut email-to-deploy
workflow:

1. **Send an email** to the Airut agent with your request
2. **Receive a response** with a Cloudflare Pages preview URL
3. **Review the PR** and approve to deploy to production

No local development environment needed. Just email instructions and get
working previews.
...
documentation on setting up email-driven agent workflows for your own projects.
